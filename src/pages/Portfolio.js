    ...
    <div className="mainCont grid grid-cols-1 lg2:grid-cols-[300px,1fr,350px] overflow-y-hidden ">
      ...
      <div className="sidebar-scroll bg-transparent-main-color p-5 rounded-lg lg2:rounded-tl-lg lg2:rounded-tr-lg h-full lg2:max-h-screen overflow-y-auto">
        <div className="bg-white rounded-xl px-4 py-4 sm2:py-2 flex items-center justify-between flex-col gap-2 sm2:gap-0 sm2:flex-row">
          ...
          <div className={`bg-white z-[99] border w-auto absolute top-full left-0 px-2 py-2 border-[#F2F2F2] rounded-2xl ${showDropDown === false ? "hidden" : "flex"}`}>
             <div>
            
             <div className="">
                <div className="sidebar-scroll max-h-[200px] overflow-y-auto flex flex-col w-fit items-center gap-2">
                <label htmlFor="bitcoin1sadasd" className='flex items-center gap-5 cursor-pointer'><div className="flex items-center gap-2 text-[#11047A] font-bold text-[15px]"><img src="/images/btc.svg" alt="icon" /> Bitcoin</div><input type="radio" id="bitcoin1sadasd" name="select-network" className='cursor-pointer w-[15px] h-[15px]' /></label>
                <label htmlFor="adsasd32r" className='flex items-center gap-5 cursor-pointer'><div className="flex items-center gap-2 text-[#11047A] font-bold text-[15px]"><img src="/images/btc.svg" alt="icon" /> Bitcoin</div><input type="radio" id="adsasd32r" name="select-network" className='cursor-pointer w-[15px] h-[15px]' /></label>
                <label htmlFor="asdasd23" className='flex items-center gap-5 cursor-pointer'><div className="flex items-center gap-2 text-[#11047A] font-bold text-[15px]"><img src="/images/btc.svg" alt="icon" /> Bitcoin</div><input type="radio" id="asdasd23" name="select-network" className='cursor-pointer w-[15px] h-[15px]' /></label>
                <label htmlFor="asdasd32df" className='flex items-center gap-5 cursor-pointer'><div className="flex items-center gap-2 text-[#11047A] font-bold text-[15px]"><img src="/images/btc.svg" alt="icon" /> Bitcoin</div><input type="radio" id="asdasd32df" name="select-network" className='cursor-pointer w-[15px] h-[15px]' /></label>
                <label htmlFor="bitcoin5dfgfgfd" className='flex items-center gap-5 cursor-pointer'><div className="flex items-center gap-2 text-[#11047A] font-bold text-[15px]"><img src="/images/btc.svg" alt="icon" /> Bitcoin</div><input type="radio" id="bitcoin5dfgfgfd" name="select-network" className='cursor-pointer w-[15px] h-[15px]' /></label>
                <label htmlFor="asjkdnasjkdnajksdn" className='flex items-center gap-5 cursor-pointer'><div className="flex items-center gap-2 text-[#11047A] font-bold text-[15px]"><img src="/images/btc.svg" alt="icon" /> Bitcoin</div><input type="radio" id="asjkdnasjkdnajksdn" name="select-network" className='cursor-pointer w-[15px] h-[15px]' /></label>
                <label htmlFor="janfksjdfnjksdfniuew" className='flex items-center gap-5 cursor-pointer'><div className="flex items-center gap-2 text-[#11047A] font-bold text-[15px]"><img src="/images/btc.svg" alt="icon" /> Bitcoin</div><input type="radio" id="janfksjdfnjksdfniuew" name="select-network" className='cursor-pointer w-[15px] h-[15px]' /></label>

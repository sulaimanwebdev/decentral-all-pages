  ...
  return (
    ...
    <div className="mainCont grid grid-cols-1 lg2:grid-cols-[300px,1fr,350px] overflow-y-hidden ">
      ...
      <div className='my-5'>
        ...
        <button className='mt-6 px-5 py-3 sm:px-7 sm:py-4 rounded-xl bg-main-color text-white'>Save Change</button>
        ...
        <button className='mt-6 px-5 py-3 sm:px-7 sm:py-4 rounded-xl bg-main-color text-white'>Update Password</button>
